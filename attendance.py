...
window.configure(background='#dbaef9')
...
def takeImage():
    ...
    if name.isalpha():
        ...
        res = 'Student details saved with: \n register number: ' + Id + ' and  Full Name: ' + name
...
label1 = tk.Label(window,fg="black", text="Name :", width=10, height=1,
                  font=('Helvetica', 16))
label1.place(x=83, y=40)

std_name = tk.Entry(window,background="black", fg="white", width=25, font=('Helvetica', 14))
std_name.place(x=280, y=41)

label2 = tk.Label(window, fg="black", text="Register Number :", width=14, height=1,
                  font=('Helvetica', 16))

label2.place(x=100, y=90)
std_number = tk.Entry(window,background="black", fg="white", width=25, font=('Helvetica', 14))
...
label3 = tk.Label(window, background="white", fg="red", text="Notification", width=10, height=1,
